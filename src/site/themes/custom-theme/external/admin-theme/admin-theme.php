...
function slate_files() {
  wp_enqueue_style( 'slate-admin-theme', get_template_directory_uri() . '/external/admin-theme/css/slate.css', array(), '1.1.6' );
  wp_enqueue_script( 'slate', get_template_directory_uri() . '/external/admin-theme/js/slate.js', array( 'jquery' ), '1.1.6' );
}
